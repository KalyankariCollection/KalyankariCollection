...
- **uBlock Origin Lite** — for Chrome (Manifest V3) users
...
- **[VuePress 2](https://v2.vuepress.vuejs.org/)** — Static site generator
- **[VuePress Theme Hope](https://theme-hope.vuejs.press/)** — Feature-rich theme
